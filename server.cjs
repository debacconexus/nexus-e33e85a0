...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Maternal Mortality Surveillance Network";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "maternal_death_case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "maternal_death_case_records";
'use strict';
